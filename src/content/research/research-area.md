...
총층이 쌓여 만들어진 전이금속 칼코게나이드 물질은 차세대 소자의 구성 물질로서 잠재력을 갖고 있기 때문에 새로운 흥미를 끌며 많은 관심을 받고 있다.  

(여기에 본문 계속…)

(중간에 그림을 끼워 넣고 싶은 위치에 아래 Figure 블록을 넣으면 됨)

<figure class="rc-figure rc-figure--center" style="--rc-w: 50%;">
...
<figure class="rc-float rc-float--left" style="--rc-w: 20%;">
...
<div class="rc-two-up">
  <figure class="rc-figure">
    <img src="/uploads/스크린샷-2025-07-10-151816.png" alt="" />
    <figcaption>지브리</figcaption>
  </figure>
  <figure class="rc-figure">
    <img src="/uploads/스크린샷-2025-07-10-153100.png" alt="" />
    <figcaption>집으리</figcaption>
  </figure>
</div>
